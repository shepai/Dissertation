...
imgOriginalSceneB=imgOriginalSceneB[40:]
imgOriginalSceneA=imgOriginalSceneA[:len(imgOriginalSceneA)-40]

#imgOriginalSceneA,imgOriginalSceneB=Kmeans(imgOriginalSceneA,imgOriginalSceneB)

imgOriginalSceneA1 = cv.imread("D:\Documents\Computer Science\Year 3\Dissertation\Dev\Computer vision\StereoDat\ 2L.png")
imgOriginalSceneB1 = cv.imread("D:\Documents\Computer Science\Year 3\Dissertation\Dev\Computer vision\StereoDat\ 2R.png")
imgOriginalSceneB1=imgOriginalSceneB1[40:]
imgOriginalSceneA1=imgOriginalSceneA1[:len(imgOriginalSceneA1)-40]
Pastdisp,frame0_new,frame1_new=readAndStereo(imgOriginalSceneB1,imgOriginalSceneA1)
c=0
...
plt.subplot(1,3,2)
plt.title("Results of stereo imaging on the Arducam with removal of difference")
